...
def print_tensorboard(writer, FOLD, DATASET, train_loss, train_loss_sup, train_loss_mmd, train_f1, val_loss, val_sens, val_spec, val_f1, val_auc, epoch):

    # --- TRAIN METRICS ---
    # Loss Total
    writer.add_scalar(f"Fold{FOLD}_{DATASET}/Train/Loss_Total", train_loss, epoch)
    
    # Componentes da Loss (Crucial para debug de Domain Adaptation)
    writer.add_scalar(f"Fold{FOLD}_{DATASET}/Train/Loss_Sup", train_loss_sup, epoch)
