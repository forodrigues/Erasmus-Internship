...
def print_tensorboard(writer, FOLD, DATASET, tr_loss, tr_loss_mmd, tr_f1, val_f1, val_auc, val_snd, im_score, test_auc, epoch):
    # Train Metrics
    writer.add_scalar(f"Fold{FOLD}_{DATASET}/Train/Loss", tr_loss, epoch)

    writer.add_scalar(f"Fold{FOLD}_{DATASET}/Train/LossReg", tr_loss_mmd, epoch)
